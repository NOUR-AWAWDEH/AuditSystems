...
public sealed class UpdateAuditPlanSummaryReportValidator : AbstractValidator<UpdateAuditPlanSummaryReportCommand>
{
    public UpdateAuditPlanSummaryReportValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty()
