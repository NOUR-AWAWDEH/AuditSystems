...
public sealed class UpdateJobTimeAllocationReportValidator : AbstractValidator<UpdateJobTimeAllocationReportCommand>
{
    public UpdateJobTimeAllocationReportValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty()
